...
// Re-export unified engine helpers for external consumers
export { simulateQuickBattle } from "./battle-engine.js";
...
function getTypeAdvantage(attacker: BeyType | undefined, defender: BeyType | undefined): number {
...
export async function getDeckStats(discordId: string): Promise<BattleStats | null> {
...
function calculateBattleScores(statsA: BattleStats, statsB: BattleStats): BattleScoreResult {
