    ...
    buttons: [
      {
        ...
        roleKey: "Participant",
        description: "Vous serez notifié des inscriptions et débuts de tournois.",
      },
      {
    ...
    buttons: [
      {
        ...
        roleKey: "Reseaux",
        description: "Notifications pour les nouvelles vidéos et posts réseaux sociaux.",
      },
      {
        ...
        style: ButtonStyle.Primary,
        roleKey: "Events",
        description: "Notifications pour les lives Twitch et événements spéciaux.",
      },
      {
        customId: "role-leaks",
    ...
    buttons: [
      {
        ...
        style: ButtonStyle.Success,
        roleKey: "Mudae",
        description: "Vous avez accepté les règles Mudae et avez désormais accès aux salons.",
      },
    ],
  },
];
