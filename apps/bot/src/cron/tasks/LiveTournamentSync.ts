import { getUnderwayTournaments, scrapeAndSyncTournament } from "../../lib/challonge-sync.js";
...
export async function liveTournamentSyncTask() {
  ...
  try {
    ...
    logger.info(`[Cron] ${tournaments.length} tournoi(s) en cours à synchroniser`);
