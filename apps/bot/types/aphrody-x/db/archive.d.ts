...
export declare function archiveTweetToTweet(elem: any, owner: {
    username: string;
    name: string;
}): Tweet | null;
/** Import a tweets archive into the SQLite store. */
export declare function importArchive(store: Store, path: string, ownerHandle: string): Promise<number>;
