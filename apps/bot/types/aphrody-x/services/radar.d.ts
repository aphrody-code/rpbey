...
export declare function radarSearch(client: XClient, rawQuery: string, opts?: RadarSearchOptions): Promise<TweetPage>;
export declare function radarSearchAll(client: XClient, rawQuery: string, maxPages?: number, opts?: Omit<RadarSearchOptions, "cursor">): Promise<{
    tweets: Tweet[];
    pages: number;
}>;
export declare function radarMetrics(client: XClient, rawQuery: string, maxPages?: number, opts?: Omit<RadarSearchOptions, "cursor">): Promise<RadarMetrics>;
