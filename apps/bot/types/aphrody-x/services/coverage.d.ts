...
export interface CoverageReport {
    ...
    premium_fetch?: Record<string, {
        ok: boolean;
    }>;
}
/** Compare embedded catalog vs live bundle + optional live Premium probe. */
export declare function buildCoverageReport(client?: XClient, opts?: {
    probePremium?: boolean;
    checkQueryIds?: boolean;
}): Promise<CoverageReport>;
/** Resolve queryId: runtime cache → catalog (documents resolution order). */
export declare function resolveOperationQueryId(opName: string, runtimeId?: string): string | undefined;
