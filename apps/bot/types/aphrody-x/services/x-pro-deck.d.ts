...
export declare function createDeck(client: XClient, name: string, columns?: Array<{
    pathname: string;
    width?: string;
}>): Promise<string | null>;
export declare function updateDeck(client: XClient, deckId: string, config: XProDeckConfig): Promise<unknown>;
...
export declare function createColumn(client: XClient, deckId: string, column: {
    pathname: string;
    width?: string;
    media_preview?: string;
}): Promise<unknown>;
export declare function updateColumn(client: XClient, deckId: string, columnId: string, column: Partial<XProDeckColumn>): Promise<unknown>;
export declare function removeColumn(client: XClient, deckId: string, columnId: string): Promise<unknown>;
export declare function reorderColumns(client: XClient, deckId: string, columnIds: string[]): Promise<unknown>;
