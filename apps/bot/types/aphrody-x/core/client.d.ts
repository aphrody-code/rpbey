...
export declare const WEB_BEARER = "AAAAAAAAAAAAAAAAAAAAANRILgAAAAAAnNwIzUejRCOuH5E6I8xnZz4puTs%3D1Zv7ttfk8LF81IUq16cHjhLTvJu4FA33AGWWjCpTnA";
export declare const CHROME_UA = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36";
...
export declare function authHeaders(session: XSession, clientUuid: string, clientDeviceId: string): Record<string, string>;
export declare class XClient {
    ...
    graphqlWaiting(opName: string, variables: any, extraFeatures?: any, maxWaitMs?: number): Promise<any>;
    ...
    search(query: string, count: number, cursor?: string, product?: string, quoteDepth?: number): Promise<TweetPage>;
    userTweets(userId: string, count: number, cursor?: string, quoteDepth?: number): Promise<TweetPage>;
    ...
    listTimeline(listId: string, count: number, cursor?: string, quoteDepth?: number): Promise<TweetPage>;
