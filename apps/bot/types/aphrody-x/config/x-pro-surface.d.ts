...
export declare const X_PRO_ROUTES: readonly [
  "/i/decks",
  "/i/decks/new",
  "/i/decks/manage",
  "/i/columns/picker",
...
export declare const GRYPHON_GRAPHQL_OPS: readonly [
  "ViewerAccountSync",
  "CreateDeck",
  "UpdateDeck",
  "RemoveDeck",
...
export declare const X_PRO_COLUMN_TIMELINE_OPS: readonly [
  "GenericTimelineById",
  "HomeTimeline",
  "HomeLatestTimeline",
  "SearchTimeline",
...
export declare const X_PRO_RECON_URLS: readonly [
  "https://pro.x.com",
  "https://pro.x.com/i/decks/new",
  `https://pro.x.com/i/decks/${string}`,
];
