...
export declare const RADAR_GRAPHQL_OPS: readonly ["SearchTimeline", "ExplorePage", "ExploreSidebar"];
...
export declare const RADAR_QUERY_SYNTAX_HELP: readonly ["\"exact phrase\"", "term1 OR term2", "term -exclude", "term min_faves:100", "term url:domain", "@handle", "from:user"];
