    ...
    >
      ...
      <Box
        sx={{
          ...
          background: isDark ? "linear-gradient(90deg, #0a0a0a 0%, #111 100%)" : "rgba(0,0,0,0.01)",
        }}
      >
          ...
          <>
            {loading && (
              ...
              >
                <Skeleton
                  ...
                  sx={{
                    borderRadius: 2,
                    bgcolor: isDark ? "rgba(255,255,255,0.02)" : "rgba(0,0,0,0.05)",
                  }}
                  animation="wave"
                />
              </Box>
            ...
            <iframe
              ...
              style={{
                ...
                filter: isDark
                  ? "invert(0.9) hue-rotate(180deg) brightness(1.1) contrast(1.1)"
                  : "none",
