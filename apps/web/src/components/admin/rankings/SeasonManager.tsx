          ...
          <Box sx={{ mb: 3, p: 2, bgcolor: "action.hover", borderRadius: 2 }}>
            ...
            <Box sx={{ mt: 2, display: "flex", gap: 1 }}>
              <Button
                ...
                size="small"
                onClick={() =>
                  window.open("/api/admin/export/rankings?seasonId=current&format=csv")
                }
              >
                Export CSV
              </Button>
              <Button
                ...
                size="small"
                onClick={() =>
                  window.open("/api/admin/export/rankings?seasonId=current&format=json")
                }
              >
                Export JSON
              </Button>
              ...
              <ListItem key={season.id} divider>
                ...
                <Box sx={{ ml: "auto", display: "flex", gap: 1 }}>
                  <Button
                    size="small"
                    onClick={() =>
                      window.open(`/api/admin/export/rankings?seasonId=${season.id}&format=csv`)
                    }
                  >
                    CSV
                  </Button>
