...
const TOURNAMENT_INFO: Record<number, TournamentInfo> = {
  ...
  12: {
    ...
    rules: ["Double Élimination", "4 Points pour gagner", "1on1", "Édition spéciale"],
    color: "#ef4444",
    icon: "🎪",
    participants: 67,
  },
  13: {
    ...
    rules: ["Double Élimination", "4 Points pour gagner", "1on1", "Thème : Harmonie"],
    color: "#8b5cf6",
    icon: "🎵",
    participants: 46,
  },
...
export function WbHallOfFame({ champions, tournamentMetas = [] }: WbHallOfFameProps) {
  ...
  // Get info for modal
  const selectedUbNumber = selectedTournament ? getUbNumber(selectedTournament) : 0;
  const selectedInfo = TOURNAMENT_INFO[selectedUbNumber];
  const selectedChampion = champions.find((c) => c.tournament === selectedTournament);
          ...
          return (
            <Box
              ...
              sx={{
                ...
                border: "1px solid",
                borderColor: info ? alpha(info.color, 0.25) : "rgba(var(--rpb-primary-rgb), 0.2)",
            ...
            >
              ...
              >
                ...
                <Typography
                  variant="caption"
                  sx={{
                    color: info ? info.color : "rgba(var(--rpb-primary-rgb), 0.7)",
                    fontWeight: 900,
                    fontSize: "0.6rem",
              ...
              <Button
                ...
                sx={{
                  ...
                  fontSize: "0.6rem",
                  fontWeight: 900,
                  color: info ? alpha(info.color, 0.6) : "rgba(255,255,255,0.3)",
                  minHeight: 0,
                  p: 0,
                  "&:hover": {
                    color: info ? info.color : "primary.main",
      ...
      >
        <Paper
          sx={{
            ...
            bgcolor: "#111",
            border: "1px solid",
            borderColor: selectedInfo ? alpha(selectedInfo.color, 0.2) : "rgba(255,255,255,0.1)",
            overflow: "hidden",
            maxHeight: "90vh",
            overflowY: "auto",
          }}
        >
          ...
          {selectedInfo && (
            ...
            >
              <Box sx={{ position: "relative", zIndex: 1 }}>
                ...
                >
                  <Typography sx={{ fontSize: "1.5rem" }}>{selectedInfo.icon}</Typography>
                  <Box>
                    <Typography
                      variant="caption"
                      sx={{
                ...
                >
                  ...
                  >
                    <GroupsIcon sx={{ fontSize: 14, color: alpha("#fff", 0.3) }} />
                    <Typography
                      variant="caption"
                      sx={{
                        fontWeight: 800,
                  ...
                  {selectedChampion && (
                    ...
                    >
                      <EmojiEventsIcon sx={{ fontSize: 14, color: selectedInfo.color }} />
                      <Typography
                        variant="caption"
                        sx={{
                          fontWeight: 900,
          ...
          <Box
            sx={{
              height: 1,
              bgcolor: selectedInfo ? alpha(selectedInfo.color, 0.1) : alpha("#fff", 0.05),
            }}
          />
          ...
          <Box sx={{ p: 2.5, pt: 2 }}>
            ...
            {loading ? (
              <Box sx={{ display: "flex", justifyContent: "center", py: 3 }}>
                <CircularProgress size={24} sx={{ color: selectedInfo?.color || "error.main" }} />
              </Box>
            ) : (
              <Stack spacing={0.5}>
                {top10Data.map((p) => (
                  ...
                  >
                    <Box sx={{ display: "flex", alignItems: "center", gap: 1.5 }}>
                      ...
                      <Typography
                        variant="body2"
                        sx={{
                          fontWeight: p.rank === 1 ? 900 : p.rank <= 3 ? 700 : 500,
                          fontSize: "0.8rem",
                          color: p.rank === 1 ? selectedInfo?.color || "#fff" : "#fff",
                        }}
                      >
                        {p.name}
                      </Typography>
                    ...
                    {p.rank === 1 && (
                      <TrophyIcon size={14} color={selectedInfo?.color || "var(--rpb-primary)"} />
                    )}
                  </Box>
                ))}
              </Stack>
