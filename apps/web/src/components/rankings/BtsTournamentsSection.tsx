...
function TournamentAccordion({
	...
	return (
		...
		>
			...
			>
				<Trophy
					sx={{ color: "var(--rpb-primary)", fontSize: 24, flexShrink: 0 }}
				/>
				...
				{!inDb ? (
					...
					>
						<Typography variant="body2" sx={{ color: "text.secondary", mb: 2 }}>
							Ce tournoi n'a pas été importé en base — bracket disponible
							uniquement sur Challonge.
						</Typography>
					...
					<>
						...
						{tab === 1 && showPoolsTab && (
							<PoolsPanel tournamentId={tournament.dbTournamentId!} />
						)}
					</>
				)}
			</AccordionDetails>
