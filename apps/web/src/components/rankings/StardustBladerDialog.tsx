              ...
              .map((h) => {
                ...
                return (
                  <Box key={h.tournamentSlug} sx={{ mb: 0.5 }}>
                    <ListItem
                      onClick={() => setExpanded(isOpen ? null : h.tournamentSlug)}
                      sx={{
                        py: 1.2,
                        px: 1.5,
                        borderRadius: 2,
                        bgcolor: isOpen ? `${ACCENT}15` : "rgba(255,255,255,0.02)",
                        cursor: "pointer",
                        "&:hover": { bgcolor: `${ACCENT}12` },
                      }}
                      secondaryAction={isOpen ? <ExpandLessIcon /> : <ExpandMoreIcon />}
                    >
                      <ListItemText
                        primary={
                          <Box
                          ...
                          >
                            ...
                            {h.finalRank != null && (
                              <Chip
                                ...
                                sx={{
                                  bgcolor:
                                    h.finalRank <= 3 ? `${ACCENT}30` : "rgba(255,255,255,0.05)",
                                  color: h.finalRank <= 3 ? ACCENT : "text.secondary",
                                  fontWeight: 900,
                                  height: 20,
                                }}
                              />
                    ...
                    <Collapse in={isOpen} timeout="auto" unmountOnExit>
                      ...
                      >
                        <TournamentBracketDb tournamentId={h.tournamentSlug} height={500} />
                      </Box>
                    </Collapse>
                  </Box>
                );
