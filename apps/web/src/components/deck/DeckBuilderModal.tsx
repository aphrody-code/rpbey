...
export function DeckBuilderModal({ open, onClose, onSave, deck }: DeckBuilderModalProps) {
        ...
        setBeys([
          {
            ...
            assistBlade:
              (sortedBeys[0] as { assistBlade?: BeyData["assistBlade"] })?.assistBlade ?? null,
          ...
          },
          {
            ...
            assistBlade:
              (sortedBeys[1] as { assistBlade?: BeyData["assistBlade"] })?.assistBlade ?? null,
          ...
          },
          {
            ...
            assistBlade:
              (sortedBeys[2] as { assistBlade?: BeyData["assistBlade"] })?.assistBlade ?? null,
  ...
  return (
    ...
    >
      ...
      <DialogActions sx={{ bgcolor: "#0a0a0a", borderTop: "1px solid #222", p: 3 }}>
