...
export async function GET(_request: NextRequest, { params }: RouteParams) {
	try {
		...
		return new ImageResponse(
			<div
				style={{
					...
					height: "100%",
					background:
						"linear-gradient(160deg, #1a0a0a 0%, #0a0a0a 60%, #000000 100%)",
			...
			>
				...
				<div
					style={{
						...
						borderImage:
							"linear-gradient(90deg, #dc2626 0%, #fbbf24 50%, #dc2626 100%) 1",
					}}
				>
					<span
						style={{
		...
		return new Response(
			JSON.stringify({ error: "Failed to generate deck card" }),
			{
				status: 500,
				headers: { "Content-Type": "application/json" },
			},
