		...
		<Stack spacing={3}>
			...
			>
				...
				<Stack direction="row" spacing={1}>
					<Chip
						size="small"
						label={`${data.groupsCount} groupes`}
						sx={{ fontWeight: 700 }}
					/>
					<Chip
						size="small"
						label={`${data.matchesCount} matches`}
						sx={{ fontWeight: 700 }}
					/>
					<Chip
						size="small"
										...
										return (
											<Box
												...
												sx={{
													...
													borderRadius: 2,
													border: "1px solid",
													borderColor: p.advanced
														? alpha(ADVANCE_COLOR, 0.3)
														: "divider",
													bgcolor: p.advanced
														? alpha(ADVANCE_COLOR, 0.04)
														: "transparent",
												}}
											>
												<Box
												...
												>
													...
													{p.challongeUsername &&
														p.challongeUsername !== p.displayName && (
															<Typography
																variant="caption"
																sx={{
