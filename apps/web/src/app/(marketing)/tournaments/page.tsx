		...
		>
            ...
            ═══════════════════════════════════════ */}
				{(btsCards.length > 0 || nextBts) && (
					<Box
						id="bey-tamashii-series"
						sx={{ mb: { xs: 6, md: 8 }, scrollMarginTop: 80 }}
					>
						<Heading
							...
							<Grid key={series.id} size={{ xs: 12, sm: 6 }}>
								...
								>
									...
									>
										...
										<NavigateNextIcon
											sx={{ color: alpha(series.color, 0.3), fontSize: 22 }}
										/>
									</Paper>
								</Link>
							</Grid>
			...
			>
				...
				<Box sx={{ p: 2 }}>
					...
					>
						...
						<NavigateNextIcon
							sx={{ color: "rgba(var(--rpb-primary-rgb), 0.3)", fontSize: 20 }}
						/>
					</Stack>
					...
					<Stack spacing={0.75} sx={{ mb: 1.5 }}>
						...
						>
							<CalendarMonthIcon
								sx={{ fontSize: 13, color: "var(--rpb-primary)", opacity: 0.7 }}
							/>
							<Typography
								variant="caption"
								sx={{
