...
export const metadata = createPageMetadata({
	...
	description:
		"Classement officiel des Stardust Séries — la compétition régionale RPB Nord.",
...
export default async function StardustPage({ searchParams }: PageProps) {
	...
	const mode = (sp.view === "career" ? "career" : "ranking") as
		| "ranking"
		| "career";
	...
	const totalMatches = Math.floor(
		((Number(bladerStats?.totalWins) || 0) +
			(Number(bladerStats?.totalLosses) || 0)) /
			2,
	);
