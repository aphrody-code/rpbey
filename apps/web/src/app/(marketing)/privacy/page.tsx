    ...
    <Container maxWidth="lg" sx={{ py: 8 }}>
      ...
      >
        ...
        <Box component="section" sx={{ mb: 4 }}>
          ...
          >
            La République Populaire du Beyblade ("RPB", "nous") s'engage à protéger votre vie
            privée. Cette politique de confidentialité explique comment nous collectons, utilisons
            et protégeons vos informations personnelles lorsque vous utilisez notre site web et nos
            services.
          </Typography>
        </Box>
        ...
        <Box component="section" sx={{ mb: 4 }}>
          ...
          >
            Notre application utilise les services Google OAuth pour permettre aux administrateurs
            d'exporter les données de tournoi vers Google Sheets.
          </Typography>
          <Typography
            sx={{
              marginBottom: "16px",
          ...
          >
            L'utilisation et le transfert vers toute autre application des informations reçues des
          ...
          >
            Si vous connectez votre compte Google pour utiliser la fonctionnalité d'exportation vers
            Sheets :
          </Typography>
          <List dense>
            <ListItem>
