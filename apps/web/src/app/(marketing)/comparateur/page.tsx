		...
		<Box sx={{ minHeight: "100vh", bgcolor: "background.default" }}>
			...
			>
				<Container maxWidth="xl" sx={{ py: { xs: 4, md: 6 }, position: "relative" }}>
					...
					<Typography sx={{ color: "text.secondary", mt: 2, maxWidth: 720, fontSize: { xs: "0.95rem", md: "1.1rem" }, lineHeight: 1.6 }}>
					...
					{catalog && (
						<Stack direction="row" spacing={{ xs: 1.5, md: 2.5 }} sx={{ mt: 4, flexWrap: "wrap", rowGap: 1.5 }}>
							{[
								...
								<Box
									...
									sx={{
										...
										"&:hover": {
											borderColor: "color-mix(in srgb, var(--rpb-primary) 30%, var(--mui-palette-divider))",
											transform: "translateY(-2px)",
										}
									}}
								>
									<Typography sx={{ fontWeight: 900, fontSize: { xs: "1.4rem", md: "1.8rem" }, lineHeight: 1, mb: 0.5, background: `linear-gradient(135deg, ${accent}, ${accent2})`, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
										{s.n}
									</Typography>
									<Typography variant="caption" sx={{ color: "text.secondary", textTransform: "uppercase", letterSpacing: 0.8, fontWeight: 800, fontSize: "0.6rem", display: "block" }}>
										{s.l}
									</Typography>
								</Box>
							))}
							...
							{topDeals.map((g) => {
								...
								return (
									...
									>
										...
										<Typography noWrap sx={{ fontWeight: 800, fontSize: "0.85rem", color: "text.primary" }}>{g.name}</Typography>
										<Stack direction="row" sx={{ alignItems: "baseline", justifyContent: "space-between", mt: "auto" }}>
											<Typography sx={{ fontWeight: 900, color: "#22c55e", fontSize: "1.05rem", letterSpacing: "-0.01em" }}>{eur(g.cheapestEur)}</Typography>
											<Typography variant="caption" sx={{ color: "text.secondary", fontSize: "0.65rem", fontWeight: 500 }}>{g.shopCount} boutiques</Typography>
										</Stack>
									</MuiLink>
								);
							})}
