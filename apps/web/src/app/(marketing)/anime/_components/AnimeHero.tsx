    ...
    >
      ...
      <Box
        sx={{
          position: "absolute",
          inset: 0,
          background: "linear-gradient(to bottom, rgba(10,10,10,0.4) 0%, transparent 20%)",
        }}
      />
      {/* Content */}
      <AnimatePresence mode="wait">
        ...
        >
          ...
          >
            ...
            />
            {GENERATION_NAMES[series.generation] || series.generation} · {series.year} ·{" "}
          ...
          {featured.map((item, i) => (
            <Box
              ...
              sx={{
                ...
                height: 4,
                borderRadius: 2,
                bgcolor: i === current ? "rgba(255,255,255,0.3)" : "rgba(255,255,255,0.25)",
                cursor: "pointer",
