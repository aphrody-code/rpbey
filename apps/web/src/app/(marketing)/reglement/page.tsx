...
export const metadata = createPageMetadata({
  ...
  description: "Le règlement officiel de la communauté République Populaire du Beyblade.",
  path: "/reglement",
});
...
export default function RulesPage() {
  return (
    <>
      ...
      <Box
        sx={{
          background: "linear-gradient(135deg, var(--rpb-primary) 0%, #991b1b 50%, #7f1d1d 100%)",
          color: "white",
          py: { xs: 4, md: 10 },
          position: "relative",
          overflow: "hidden",
      ...
      >
        ...
        <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1 }}>
          ...
          >
            "Amusez-vous et prenez du plaisir au sein de la RPB, le but est avant tout de se réunir
            et de s’entraider autour de la passion commune qui nous anime."
          </Typography>
        </Container>
      </Box>
      <Container maxWidth="lg" sx={{ py: 8 }}>
            ...
            {RULES.map((rule, index) => (
              <Grid key={rule.title} size={{ xs: 12, md: 6 }}>
                ...
                {index < RULES.length - 2 && (
                  <Divider sx={{ mt: 4, display: { xs: "block", md: "none" } }} />
                )}
              </Grid>
            ))}
          </Grid>
        ...
        >
          ...
          >
            <Box sx={{ textAlign: { xs: "center", md: "left" } }}>
              ...
              >
                En cas de litige ou de requête spécifique, veuillez vous diriger vers les membres du
                Staff (Fondateurs, Administrateurs ou Modérateurs) sur notre serveur Discord.
              </Typography>
              <Typography
                variant="body2"
                sx={{
              ...
              >
                Toute forme de harcèlement visant un membre ou un staff de la RPB sera sévèrement
                punie.
              </Typography>
            </Box>
            <Button
        ...
        <Box sx={{ textAlign: "center", py: 4 }}>
          ...
          >
            Restez courtois et respectueux les uns envers les autres même si vos opinions divergent.
            Profitons ensemble de cette passion pour Beyblade X !
          </Typography>
        </Box>
      </Container>
    </>
