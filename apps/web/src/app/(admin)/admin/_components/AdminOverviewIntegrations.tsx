...
import { Link as LinkIcon, Settings as SettingsIcon } from "@mui/icons-material";
import {
  Box,
  Button,
  Card,
      ...
      <CardHeader
        title={
          <Stack direction="row" spacing={1}>
            <SettingsIcon /> <Typography variant="h6">Intégrations & Services</Typography>
          </Stack>
        }
      />
      <CardContent>
        <Stack spacing={2} direction={{ xs: "column", md: "row" }}>
          ...
          >
            ...
            <Button
              ...
              fullWidth
              startIcon={
                challongeStatus === "loading" ? <CircularProgress size={16} /> : <LinkIcon />
              }
