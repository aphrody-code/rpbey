...
import { CheckCircle, Circle, PlayArrow, Refresh as RefreshIcon } from "@mui/icons-material";
import {
  Box,
  Button,
  Card,
          ...
          title={
            <Stack direction="row" spacing={1.5} sx={{ alignItems: "center" }}>
              ...
              <Chip
                ...
                color={
                  isOnline ? "success" : initialStatus?.status === "starting" ? "warning" : "error"
                }
                variant="outlined"
              />
            </Stack>
        ...
        <CardContent>
          {initialStatus ? (
            ...
            <Typography variant="body2" sx={{ color: "text.secondary" }}>
              Le bot ne répond pas sur l&apos;API (`/api/status`). Vérifiez que le service
          ...
          subheader={
            <Stack direction="row" spacing={1} sx={{ alignItems: "center" }}>
              ...
              <Typography variant="caption" sx={{ color: "text.secondary" }}>
                {connected ? "Flux temps réel connecté" : "Connexion au flux…"}
              </Typography>
            </Stack>
          }
          action={
            <FormControlLabel
              ...
              label={<Typography variant="caption">Défilement auto</Typography>}
            />
          }
        />
        <Divider />
