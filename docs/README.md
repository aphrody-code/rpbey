...
- [Assistant RAG conversationnel & UI d'ambiance](rag-assistant-ui.md) `stable` — Couche de consommation du RAG rpbey : chat « Rpbey » style Gemini branché au NLP algorithmique (zéro LLM) sur la recherche hybride, et fonds d'ambiance par page/section (frames d'animé, parallaxe au scroll) tirés du corpus.
