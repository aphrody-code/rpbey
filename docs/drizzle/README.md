...
- **Colonnes en camelCase quotées** (`"createdAt"`, `"userId"`) — héritage Prisma (seules les *tables* ont `@@map` snake_case). → **NE PAS** mettre `casing: "snake_case"` ; `drizzle-kit pull` reflète l'existant.
