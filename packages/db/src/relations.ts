...
export const pointAdjustmentsRelations = relations(
	pointAdjustments,
	({ one }) => ({
...
export const gachaFriendshipsRelations = relations(
	gachaFriendships,
	({ one }) => ({
...
export const tournamentCategoriesRelations = relations(
	tournamentCategories,
	({ many }) => ({
...
export const rankingSeasonsRelations = relations(
	rankingSeasons,
	({ many }) => ({
		seasonEntries: many(seasonEntries),
	}),
...
export const animeEpisodeSourcesRelations = relations(
	animeEpisodeSources,
	({ one }) => ({
...
export const animeEpisodesRelations = relations(
	animeEpisodes,
	({ one, many }) => ({
...
export const animeWatchProgressRelations = relations(
	animeWatchProgress,
	({ one }) => ({
		animeEpisode: one(animeEpisodes, {
