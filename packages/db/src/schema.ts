...
export const analyticsEvents = pgTable(
  ...
  (table) => [
    ...
    index("analytics_events_type_idx").using("btree", table.type.asc().nullsLast().op("text_ops")),
    index("analytics_events_path_idx").using("btree", table.path.asc().nullsLast().op("text_ops")),
...
export const gachaFriendships = pgTable(
  ...
  (table) => [
    primaryKey({ columns: [table.userId, table.friendId], name: "gacha_friendships_pkey" }),
    foreignKey({
