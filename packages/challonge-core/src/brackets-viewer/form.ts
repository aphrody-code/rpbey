import { type GrandFinalType, type InputStage, type RoundRobinMode, type SeedOrdering, type StageSettings, type StageType } from '../brackets-model/index';
import { t } from './lang';
import { helpers } from '../brackets-manager/index';
import { type Database } from '../brackets-manager/index';
...
if (typeof window !== 'undefined') {
    (window as any).stageFormCreator = stageFormCreator;
    (window as any).updateFormCreator = updateFormCreator;
}
