...
import { type ToI18nKey, type TFunction, type TranslateFn } from "./lang";

export type { ToI18nKey, TFunction, TranslateFn };
 ...
 */
export type RoundNameGetter = (info: RoundNameInfo, t: TranslateFn) => string;
